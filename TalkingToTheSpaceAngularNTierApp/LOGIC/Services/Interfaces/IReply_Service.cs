...
namespace LOGIC.Services.Interfaces
{
    public interface IReply_Service
    {
        ...
        Task<Generic_ResultSet<Reply_ResultSet>> AddReply(string reply_content, string reply_status, DateTime reply_sent_date, Int64 user_id, Int64 message_id);
        Task<Generic_ResultSet<Reply_ResultSet>> UpdateReply(Int64 reply_id, string reply_content, string reply_status, DateTime reply_modified_date, DateTime reply_sent_date, Int64 user_id, Int64 message_id);
